...
import VenueMap from "@/components/data-visualization/VenueMap";
...
import CrowdSimulation from "@/components/data-visualization/CrowdSimulation";
    ...
    <div className="min-h-screen flex flex-col bg-muted/30">
      ...
      <header className="border-b bg-white shadow-sm">
        <div className="container mx-auto py-3 px-4">
          <div className="flex justify-between items-center">
            <Logo />
            <p className="text-sm text-muted-foreground">Navigate Crowds, Amplify Safety</p>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 container mx-auto py-6 px-4">
        <Tabs defaultValue="overview" value={activeModule} onValueChange={setActiveModule}>
          <div className="mb-6">
            <h1 className="text-2xl font-bold">Crowd Management and Navigation System</h1>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4 mt-4">
                  <div className="bg-white rounded-lg p-3 border text-center">
                    <div className="text-3xl font-bold text-density-low">2.4</div>
                    <div className="text-sm text-muted-foreground">Avg. Density (people/m²)</div>
                  </div>
                  
                  <div className="bg-white rounded-lg p-3 border text-center">
                    <div className="text-3xl font-bold text-density-high">3</div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-right">
              ...
              <p className="text-xs mt-1 text-white/70">© 2023 CrowdPathPulse. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
